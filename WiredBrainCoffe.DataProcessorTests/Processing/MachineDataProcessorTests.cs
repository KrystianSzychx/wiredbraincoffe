...
{
    private readonly ExampleCoffeCountStore _coffeCountStore;
    private readonly MachineDataProcessor _machineDataProcessor;

    public MachineDataProcessorTests()
    {
       _coffeCountStore = new ExampleCoffeCountStore();
...
public class ExampleCoffeCountStore : ICoffeCountStore
{
